...
namespace RMS
{
    public partial class ViewMenu : Form
    {
        ...
        private void ViewMenu_Load(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\ME\Downloads\RMS\RMS\Database1.mdf;Integrated Security=True;Connect Timeout=30");
                con.Open();
